...
### 3.2. 원격 저장소 등록
- 연결 방법
	1. 먼저 원격 저장소를 생성하고, 이후 로컬 저장소를 연결하는 방법 → [[05 Server#5. 자동으로 내려받기 (clone & pull)|5. clone & pull]]
	2. 먼저 로컬 저장소를 생성하고, 이후 원격 저장소를 연결하는 방법 → [[05 Server#cf. 최초 동기화 Local to Remote|Dev.]], [[06 Branch]]
