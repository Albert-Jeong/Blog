...
- L3. ==네트워크 계층 (Network Layer)==
	- **Host to Host**
	- 데이터를 가장 효율적인 ==경로를 찾아 전달하는 라우팅(Routing)==을 수행한다.
	- ==IP 주소==를 사용하여 출발지와 목적지를 식별한다.

- L2. ==데이터링크 계층 (Data Link Layer)==
	- **Node to Node**
	- 물리 계층을 통해 데이터가 안전하게 전달되도록 한다.
	- ==MAC 주소==를 사용하여 물리적인 장치 간의 통신을 담당한다. (같은 LAN)
...
- **주요 프로토콜**
    - ==IP: 주소를 지정하고 경로를 설정==
	- -> ==OSI 7 Layer의 Network Layer 기능 수행==
...
- **주요 프로토콜**
    ...
    - -> ==OSI 7 Layer의 Transport Layer 기능 수행==
