...
1. n개의 노드에 대한 [완전 이진 트리](https://ko.wikipedia.org/wiki/%EC%99%84%EC%A0%84_%EC%9D%B4%EC%A7%84_%ED%8A%B8%EB%A6%AC "완전 이진 트리")를 구성한다.
	- 이때 루트 노드부터 부모노드, 왼쪽 자식노드, 오른쪽 자식노드 순으로 구성한다.
2. 최대 힙을 구성한다.
	- 최대 힙이란 부모노드가 자식노드보다 큰 트리를 말하는데,
