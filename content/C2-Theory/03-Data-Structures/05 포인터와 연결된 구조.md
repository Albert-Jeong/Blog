...
- **포인터**(Pointer)
	- 메모리의 주소를 저장하는 변수
	- **반드시 NULL로 초기화**![[03 변수와 데이터 입력#^garbage]]
...
- **자체 참조 구조체**(self-referential structure)
	...
	- (연결 리스트의 노드 구현 시 필수)
	- [[17 사용자 정의 자료형#2.3. 자기 참조 구조체 (17-9.c)]]
```c
...
![[02-2 명령어#cf. RAM 메모리 구조]]
![[04 객체 포인터와 객체 배열, 객체의 동적 생성#cf. 세그폴트]]
...
## 3. 연결된 구조
![[01 Data Structure & Algorithm#2.2. 저장 방식에 따른 분류]]
